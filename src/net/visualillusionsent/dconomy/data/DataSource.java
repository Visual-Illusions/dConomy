...
public class DataSource {
    ...
    public void createJointAccount(String accname, String owner){
        jointmap.put(accname, new JointAccount(new String[]{""}, new String[]{owner}, 0, DCoProperties.getJointMaxDraw(), DCoProperties.getJointDelay(), DCoProperties.getJointDelay(), null));
    }
