...
public final class WalletSetCommand extends WalletCommand {

    public WalletSetCommand(WalletHandler handler) {
        super(2, handler);
    }
    ...
    protected final void execute(dConomyUser user, String[] args) {
        ...
        try {
            handler.getWalletByName(theUser.getName()).setBalance(args[0]);
